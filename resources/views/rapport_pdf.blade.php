...
<body>
    ...
    <div class="sar-section">
      ...
      <div class="sar-section">
        ...
        @else
            <p>Aucun AVURNAV enregistré durant {{ $filterResult }}</p>
        @endif
    </div>
    ...
    <div class="sar-section">
        ...
        @if(isset($cabotageBase64) && isset($cabotageData))
            <div class="chart-desc"> 
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        <thead class="table-dark">
                ...
                <div class="chart-desc">
                    <p>Tableau 3 : Récapitulatif suivi cabotage</p>
                </div>
            </div>
            <div class="chart-image">
                <img src="{{ $cabotageBase64 }}" alt="Graphique cabotage">
            </div>
            <p>
                @php
